			...
			<div class="col-md-12">
				<div class="card ">
					<div class="card-header text-center">
						...
						<h4 class="card-title">Send Reset Password Request</h4>
						<?= $this->session->flashdata('msg') ?>
					</div>
					<?= form_open_multipart('umum/main/send-reset-password') ?>
					<div class="card-body ">
						<div class="row">
					...
					<div class="card-footer text-center">
						<button class="btn btn-primary" type="submit" name="submit" value="Send Request">
							Send Request
						</button>
					</div>
					<?= form_close() ?>
