			...
			<div class="col-md-12">
				<div class="card " style="overflow-x: scroll;">
						...
						<div class="row">
							...
							<div class="col-md-6 pr-1">
								<?php if (file_exists(FCPATH . 'assets/img/ktp-' . $data->id . '.jpg')): ?>
									<img src="<?= base_url('assets/img/ktp-' . $data->id . '.jpg?1') ?>" style="max-height: 100px;">
								<?php else: ?>
									<p>Anda belum mengupload KTP</p>
								<?php endif; ?>
								<div class="form-group">
									<label>KTP</label>
									<input type="file" accept="image/*" class="form-control" name="ktp">
								</div>
							</div>
							<div class="col-md-3 pr-1"></div>
						</div>
						<div class="row">
							...
							<div class="col-md-6 pr-1">
								<?php if (file_exists(FCPATH . 'assets/img/kk-' . $data->id . '.jpg')): ?>
									<img src="<?= base_url('assets/img/kk-' . $data->id . '.jpg?1') ?>" style="max-height: 100px;">
								<?php else: ?>
									<p>Anda belum mengupload KK</p>
								<?php endif; ?>
								<div class="form-group">
									<label>Kartu Keluarga</label>
									<input type="file" accept="image/*" class="form-control" name="kk">
								</div>
							</div>
							<div class="col-md-3 pr-1"></div>
						</div>
					...
					<div class="card-footer">
						<?php if ($data->submitted == 0): ?>
							<button class="btn btn-primary" type="submit" name="submit" value="Upload">Save</button>
							<button onclick="confirm('Jika anda submit, anda tidak bisa lagi melakukan pengeditan data. Apakah anda yakin?');" class="btn btn-success" type="submit" name="submit_final" value="Submit">Submit</button>
						<?php endif; ?>
					</div>
					<?= form_close() ?>
				</div>
